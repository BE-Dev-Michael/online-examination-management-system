...
function Dropdown() {
    ...
    const links = [{
        ...
        link: '/faculty/profile/editinformation'
    }, {
        title: 'Change Password',
        link: '/faculty/profile/changepassword'
    }, {
        title: 'Update Picture',
        link: '/faculty/profile/updatepicture'
    }]
...
const Profile = () => {
    ...
    return (
        <>
            {userData &&
                <div className="relative flex flex-col gap-10 py-5 px-0 items-center bg-white w-[80%] mx-auto rounded-2xl shadow-xl" >
                    <div className="relative flex w-[100%] bg-white">
                        <h1 className="ml-9 mt-4  text-gray-600 text-2xl font-bold dark:text-gray-300" >Account Settings</h1>
                        <Dropdown />
                    </div>

                    <div className="relative flex justify-center w-full lg:w-[60%]">
