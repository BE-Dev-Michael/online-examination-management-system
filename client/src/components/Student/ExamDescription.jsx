    ...
    <>
      {exams &&
        <div className="relative lg:flex justify-center w-10/12 lg:w-8/12">
          <div className="flex flex-col my-5 lg:w-11/12 border p-5 rounded-lg shadow-md bg-white  dark:bg-[#26292F] dark:border-[#26292F]">
            <div className="flex flex-col dark:text-[#e2dddd]">
            ...
            <div className="flex justify-center my-5">
              ...
              {new Date() >= new Date(exams.startDate) &&
                ...
                <button
                  onClick={startExam}
                  className={`w-52 py-2 px-4 bg-[#7B9EBE] hover:bg-[#6e8eac] focus:ring-[#7B9EBE] focus:ring-offset-blue-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-full`}>
                  Start
                </button>
                :
